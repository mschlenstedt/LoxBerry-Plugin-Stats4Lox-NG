$(function() {
	...
	<div data-role="navbar" class="ui-navbar" role="navigation" id="s4l_sub_nav">
		<ul class="ui-grid-d">
			<li class="ui-block-a"><a href="main_loxone.cgi" id="submenu1" class="ui-link ui-btn">${$('#lang_sub_statistic_selection').text()}</a></li>
			<li class="ui-block-b"><a href="loxone_import_report.cgi" id="submenu2" class="ui-link ui-btn">${$('#lang_sub_import_report').text()}</a></li>
			<li class="ui-block-c"><a href="mqttlive_loxone.cgi" id="submenu3" class="ui-link ui-btn">${$('#lang_sub_mqtt_live').text()}</a></li>
		</ul>
	</div>
	`;
